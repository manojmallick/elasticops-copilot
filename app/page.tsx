    ...
    <div>
      ...
      <div className="card" style={{ marginTop: '2rem' }}>
        ...
        <ul style={{ marginLeft: '1.5rem', lineHeight: '2' }}>
          <li><strong>ES|QL Spike Detection:</strong> Automatically detect error spikes in application logs</li>
          <li><strong>Intelligent Triage:</strong> Auto-classify tickets with semantic understanding</li>
          <li><strong>Deduplication:</strong> Prevent duplicate tickets using vector similarity</li>
          <li><strong>Hybrid Search:</strong> Combine BM25 and kNN for best results</li>
          <li><strong>Resolution Retrieval:</strong> Match problems to proven solutions</li>
          <li><strong>Complete Audit Trail:</strong> Full workflow observability and metrics</li>
        </ul>
      </div>
    </div>
  );
